...
verifyPledge(){
  ...
  let getTeam = teamRef.get().then(doc =>{
      ...
      let newTeamPoints = Number(teamPoints) + 200;   //Update with correct points
  ...
  let getCity = cityRef.get().then(doc => {
      ...
      let newCityPoints = Number(cityPoints) + 200;    //Update with correct points
  ...
  let getUser = userRef.get().then(doc=>{
      ...
      let newIndiPoints = Number(indiPoints) + 200;   //Update with correct points
      let newPointsIndi = {
